...
## Dropped century, as there's no way to humanize it (1900s is 1900-1999, or 1900-1909? 'nineteen hundreds' is cumbersome, and '20th century is a nightmare')
## Plus, century is at the limits of being a human timescale
#
...
#   has_many :in, :datetimeSemanticZoomIn, type: :DATETIME_SEMANTIC_ZOOM_IN, model_class: :Decade
# end
...
class Decade < AbsoluteDateNode
  ...
  has_one :out, :datetimeSemanticZoomOut, type: :DATETIME_SEMANTIC_ZOOM_OUT, model_class: :Century, unique: true
  has_many :in, :datetimeSemanticZoomIn, type: :DATETIME_SEMANTIC_ZOOM_IN, model_class: :Year
end
...
# Season belongs in the 'fuzzy dates' - could be specific to a year, and could also be in any year.
...
class Day < AbsoluteDateNode
  ...
  has_many :in, :datetimeSemanticZoomIn, type: :DATETIME_SEMANTIC_ZOOM_IN, model_class: :Day
end
...
class Hour < AbsoluteDateNode
  ...
  has_many :in, :datetimeSemanticZoomIn, type: :DATETIME_SEMANTIC_ZOOM_IN, model_class: :Minute
end
...
class Minute < AbsoluteDateNode
  ...
  has_one :out, :datetimeSemanticZoomOut, type: :DATETIME_SEMANTIC_ZOOM_OUT, model_class: :Hour, unique: true
  has_many :in, :datetimeSemanticZoomIn, type: :DATETIME_SEMANTIC_ZOOM_IN, model_class: :Second
end
...
class Second < AbsoluteDateNode
  ...
  has_many :in, :datetimeSemanticZoomIn, type: :DATETIME_SEMANTIC_ZOOM_IN, model_class: :Millisecond
end
